...
<div id="container">
    <!--①标题部分开始-->
    <div id="header">
        <font size="8" color="#00bfff">    主页>电子产品>惠普电脑</font>
    </div>
    <!--①标题部分结束-->
    <!--②左边部分开始-->
    <div id="navigation">
        <img src="huipu.jpg" width="620" height="620">
        <font size="6" color="#00bfff">    商品名称：惠普（HP）战66三代AMD版15.6英寸轻薄笔记本电脑   <br>商品毛重：1.3kg<br>商品产地：中国大陆<br>CPU型号：其他运行<br>存储卡：不支持存储卡<br>摄像头数量：后置双摄后摄主摄像素：1200万像素前摄主摄像素：1200万像素<br>主屏幕尺寸（英寸）：13英寸分辨率<br></font>

    </div>
    <!--②左边部分结束-->
    <!--③右边部分开始-->
    <div id="content">
        <font size="8" color="#00bfff">       电脑颜色  <label><input name="Fruit" type="radio" value="" />黑色 </label>
            ...
            选择版本 <label><input name="a" type="radio" value="" />标压 </label>
            <label><input name="a" type="radio" value="" />六核 </label>
            <label><input name="a" type="radio" value="" />高配 </label>
            <label><input name="a" type="radio" value="" />八核 </label><br><br>
