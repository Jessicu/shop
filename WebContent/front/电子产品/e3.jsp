...
<div id="container">
    <!--①标题部分开始-->
    <div id="header">
        <font size="8" color="#00bfff">    主页>手机>锤子</font>
    </div>
    <!--①标题部分结束-->
    <!--②左边部分开始-->
    <div id="navigation">
        <img src="chuizi.jpg" width="620" height="620">
        <font size="6" color="#00bfff">    商品名称：锤子(smartisan) 坚果Pro3 OnePlus 8  <br>商品毛重：470.00g<br>商品产地：中国大陆<br>CPU型号：其他运行<br>存储卡：不支持存储卡<br>摄像头数量：后置双摄后摄主摄像素：1200万像素前摄主摄像素：1200万像素<br>主屏幕尺寸（英寸）：6.1英寸分辨率<br></font>
