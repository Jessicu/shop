...
<div id="container">
    <!--①标题部分开始-->
    <div id="header">
        <font size="8" color="#00bfff">    主页>男装>休闲裤</font>
    </div>
    <!--①标题部分结束-->
    <!--②左边部分开始-->
    <div id="navigation">
        <img src="xiuxianku.jpg" width="620" height="620">
        <font size="6" color="#00bfff">    商品名称：【买一送一】南极人男士休闲裤    <br>上市时间：2020年春季<br>衣长：常规款<br>适用场景：休闲<br>风格：商务正装<br>工艺：免烫<br>适用人群：青年<br></font>
